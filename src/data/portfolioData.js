export const personalInfo = {
  ...
  tagline: "Building modern, scalable, and intelligent digital experiences through full-stack development and AI-driven innovation.",
  about: [
...
export const services = [
  {
    ...
    description: "Architecting responsive, lightning-fast web applications using Next.js, React, Node.js, and MongoDB. Secure, scalable, and optimized for SEO.",
    icon: "Layers"
  },
  {
    title: "Machine Learning Solutions",
    description: "Designing intelligent neural networks, natural language processors, and predictive analytics dashboards using Python, TensorFlow, and PyTorch.",
    icon: "Brain"
  },
  {
    title: "Creative UI/UX Engineering",
    description: "Developing gorgeous, motion-rich interfaces utilizing GSAP, Lenis smooth scroll, and Framer Motion for breathtaking client experiences.",
    icon: "Sparkles"
  }
];
